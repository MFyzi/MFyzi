...
***Exercise Tracker :*** This is one of the final project from Free Code Camp's cirtification in 'Backend Development and APIs', I have written the entire backend of this project in 'express' and 'mongodb' as database  <picture> <img alt="Shows an illustrated sun in light mode and a moon with stars in dark mode." src="./images/exercise tracker.png" width="1800"> </picture><br><a href="https://github.com/MuhammadFyroozRazi/freecode-exercise-tracker" target="_blank" rel="noreferrer">code link<img src="./images/link.svg" width="24" height="13" alt="JavaScript" /> <br> <a href="https://boilerplate-project-exercisetracker-1.muhammadfyroozr.repl.co/" target="_blank" rel="noreferrer">link to app<img src="./images/link.svg" width="24" height="13" alt="JavaScript" />  |***File Metadata Microservice :*** This is also one of the final project from Free Code Camp's cirtification in 'Backend Development and APIs', this is an simple microservece to show the metadata of uploaded file. I wrote the backend in express and uses 'multer' package for accessing file data<br><picture> <img alt="Shows an illustrated sun in light mode and a moon with stars in dark mode." src="./images//metadata freecodecamp.png" width="360"> </picture> <br><br><a href="https://github.com/MuhammadFyroozRazi/freecode-file-metadata-microservice" target="_blank" rel="noreferrer">code link<img src="./images/link.svg" width="24" height="13" alt="JavaScript" /> <br> <a href="https://boilerplate-project-filemetadata.muhammadfyroozr.repl.co/ " target="_blank" rel="noreferrer">link to app<img src="./images/link.svg" width="24" height="13" alt="JavaScript" />  
|--|--
